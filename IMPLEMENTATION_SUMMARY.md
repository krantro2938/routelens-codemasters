...
- Банк нормализуется через `strip.downcase`. Пустой список поддерживает все банки; непустой список работает как allowlist или denylist в зависимости от `exclude_banks`.
