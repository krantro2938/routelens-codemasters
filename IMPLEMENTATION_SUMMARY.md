...
- автоматизированные тесты: **140 тестов, 754 проверки, 0 сбоев**;
...
- RPM складывает базовое число запросов из снимка и локальные попытки запуска в той же минуте.
...
| Тесты | 140 тестов, 754 проверки, всё пройдено |
| Публичный валидатор | 29 пройдено, 0 ошибок, 0 предупреждений |
